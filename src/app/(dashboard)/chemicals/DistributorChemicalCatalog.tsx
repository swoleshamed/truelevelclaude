...
export function DistributorChemicalCatalog({
  ...
  const getTypeColor = (type: string): string => {
    const colors: Record<string, string> = {
      ...
      WHEEL_TIRE_CLEANER: 'bg-yellow-100 text-yellow-800',
      FOAM_DETERGENT: 'bg-purple-100 text-purple-800',
      FRAGRANCE: 'bg-pink-100 text-pink-800',
      TRI_COLOR: 'bg-violet-100 text-violet-800',
      PROTECTANT: 'bg-green-100 text-green-800',
      DRY_AGENT: 'bg-cyan-100 text-cyan-800',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Select
            ...
            options={[
              ...
              { value: 'WHEEL_TIRE_CLEANER', label: 'Wheel & Tire Cleaner' },
              { value: 'FOAM_DETERGENT', label: 'Foam Detergent' },
              { value: 'FRAGRANCE', label: 'Fragrance' },
              { value: 'TRI_COLOR', label: 'Tri-Color' },
              { value: 'PROTECTANT', label: 'Protectant' },
              { value: 'DRY_AGENT', label: 'Dry Agent' },
